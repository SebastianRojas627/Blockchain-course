...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider(mnemonic, 'https://rinkeby.infura.io/v3/150d2212c37a43f2a1ad66e95616a681'),
      network_id: 4
    },
    ...
    ethereum: {
      provider: () => new HDWalletProvider(mnemonic, 'https://mainnet.infura.io/v3/579ccdf699df462b8bbbe63969440fda'),
      network_id: 1
    }
